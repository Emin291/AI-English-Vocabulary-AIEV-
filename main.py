...
# res = []
# while helper < 5:
#     if synonym_example_list[count] != "None":
#         if synonym_example_list[count] not in res:
#             search(synonym_example_list[count])
#             res.append(synonym_example_list[count])
#             helper+=1
#     count+=1
...
# Convert the logo image to base64
    ...
    #     st.image(Image1, width = 512, caption = 'keep calm')
